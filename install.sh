...
apt-get update -qq
apt-get install -y -qq software-properties-common curl wget gnupg nftables iptables qrencode
log_success "Base dependencies installed"

log_step "Configuring Amnezia PPA and installing AmneziaWG packages"
